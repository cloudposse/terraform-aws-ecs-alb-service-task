...
| <a name="input_ecs_service_name"></a> [ecs\_service\_name](#input\_ecs\_service\_name) | If string is not null, use the string as the name of the ECS service. <br>Otherwise a name will be generated. | `string` | `null` | no |
